...
import lockClosed from '@iconify-icons/mdi/lock-outline';
...
export default function Features() {
  return (
    <div className="bg-white py-24 sm:py-32 dark:bg-black h-screen min-h-dvh">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-primary">Deploy faster</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight bg-gradient-to-r from-[#ff8a00] via-[#e52e71] to-[#9b00ff] bg-clip-text text-transparent sm:text-4xl">
