...
const NotificationIcon: React.FC<IconSvgProps> = ({ size, height, width, ...props }) => {
  return (
    <svg
      fill="none"
      height={size || height || 24}
...
const TrashCanIcon: React.FC<IconSvgProps> = ({ size, height, width, ...props }) => {
  return (
    <svg
      fill="none"
      height={size || height || 24}
...
const SaveIcon: React.FC<IconSvgProps> = ({ size, height, width, ...props }) => {
  return (
    <svg
      fill="none"
...
const CloseIcon: React.FC<IconSvgProps> = ({ size, height, width, ...props }) => {
  return (
    <svg
      fill="none"
      fill-rule="evenodd"
...
const CameraIcon: React.FC<IconSvgProps> = ({ fill, size, height, width, ...props }) => {
  return (
    <svg
      fill="none"
      height={size || height || 24}
...
const ErrorIcon: React.FC<IconSvgProps> = ({ size, height, width, ...props }) => {
  return (
    <svg
      fill="#e84f4f"
      height={size || height || 24}
...
const MoonIcon: React.FC<IconSvgProps> = ({ size, height, width, ...props }) => {
  return (
    <svg
      aria-hidden="true"
      fill="#e84f4f"
...
const SunIcon: React.FC<IconSvgProps> = ({ size, height, width, ...props }) => {
  return (
    <svg
      aria-hidden="true"
      fill="#e84f4f"
...
// #E1251B
const AdobeIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
  <svg
    aria-hidden="true"
    aria-label="Adobe"
    fill="currentColor"
